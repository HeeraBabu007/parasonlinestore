...
import com.mvc.dao.*;
import com.mvc.entity.AppRole;
import com.mvc.entity.AppUser;
import com.mvc.form.AppUserForm;
import com.mvc.springboot.rest.repository.ProductRepository;
import com.mvc.utils.SecurityUtil;
import com.mvc.utils.WebUtils;
import com.mvc.validator.AppUserValidator;
...
public class MainController {
	...
	public String welcomePage(Model model) {
		model.addAttribute("message", "You have been successfully logged in. Welcome to Paras Online Store!");
		return "welcomePage";
	}
	...
	public String shippingPage(Model model) {
		model.addAttribute("price", "RS. 397");
...
/*
	...
	public String signupPage(WebRequest request, Model model) {
		System.out.println("Calling for Signup");
